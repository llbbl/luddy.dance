...
export default function Component() {
  ...
  return (
    <div className="bg-gradient-to-br from-[#F59E0B] to-[#F472B6] h-screen flex flex-col items-center justify-start pt-16 lg:pt-32"> {/* Adjusted padding-top */}
      ...
      <section className="flex justify-center w-full mt-6 px-4"> {/* Added padding to section */}
        <div className="aspect-youtube w-full flex justify-center relative" style={{ maxWidth: '80vw' }}> {/* Set maximum width to 80% of viewport width */}
          {!isIframeLoaded && (
            <img
